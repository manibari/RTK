...
const cities: PlaceNode[] = [
  ...
  { id: "chengdu", name: "成都", description: "天府之國，蜀地核心", lat: 30.57, lng: 104.07, status: "allied", tier: "major", controllerId: "liu_bei", gold: 0, garrison: 2, development: 0, specialty: "military_academy", food: 100 },
  { id: "luoyang", name: "洛陽", description: "千年帝都，中原之心", lat: 34.62, lng: 112.45, status: "hostile", tier: "major", controllerId: "cao_cao", gold: 0, garrison: 2, development: 0, specialty: "forge", food: 100 },
  { id: "jianye", name: "南京", description: "六朝古都，江南門戶", lat: 32.06, lng: 118.80, status: "neutral", tier: "major", controllerId: "sun_quan", gold: 0, garrison: 2, development: 0, specialty: "harbor", food: 100 },
  { id: "xiapi", name: "徐州", description: "兵家必爭，五省通衢", lat: 34.32, lng: 117.95, status: "hostile", tier: "major", controllerId: "lu_bu", gold: 0, garrison: 2, development: 0, specialty: "market", food: 100 },
  { id: "changan", name: "西安", description: "十三朝古都", lat: 34.26, lng: 108.94, status: "hostile", tier: "major", controllerId: "cao_cao", gold: 0, garrison: 2, development: 0, specialty: "market", food: 100 },
  { id: "xiangyang", name: "襄陽", description: "荊楚屏障，南北要衝", lat: 32.01, lng: 112.14, status: "neutral", tier: "major", gold: 0, garrison: 0, development: 0, specialty: "library", food: 100 },

  // === Minor cities ===
  // Shu-controlled
  { id: "hanzhong", name: "漢中", description: "蜀道咽喉，北伐前線", lat: 33.07, lng: 107.03, status: "allied", tier: "minor", controllerId: "liu_bei", gold: 0, garrison: 1, development: 0, specialty: "granary", food: 60 },
  { id: "xinye", name: "新野", description: "三顧茅廬之地", lat: 32.52, lng: 112.36, status: "allied", tier: "minor", controllerId: "liu_bei", gold: 0, garrison: 1, development: 0, specialty: "library", food: 60 },
  { id: "jiameng", name: "廣元", description: "蜀北門戶，劍門天險", lat: 32.43, lng: 105.82, status: "allied", tier: "minor", controllerId: "liu_bei", gold: 0, garrison: 1, development: 0, specialty: "granary", food: 60 },
  { id: "jiangzhou", name: "重慶", description: "巴蜀要地，長江上游", lat: 29.56, lng: 106.55, status: "allied", tier: "minor", controllerId: "liu_bei", gold: 0, garrison: 1, development: 0, specialty: "granary", food: 60 },
  ...
  // Wu-controlled
  { id: "jiangxia", name: "武漢", description: "九省通衢，長江樞紐", lat: 30.55, lng: 114.34, status: "neutral", tier: "minor", controllerId: "sun_quan", gold: 0, garrison: 1, development: 0, specialty: "harbor", food: 60 },
  { id: "kuaiji", name: "紹興", description: "越地名城，東南水鄉", lat: 30.00, lng: 120.58, status: "neutral", tier: "minor", controllerId: "sun_quan", gold: 0, garrison: 1, development: 0, specialty: "harbor", food: 60 },

  // Neutral / contested
  { id: "changsha", name: "長沙", description: "湘楚要地，魚米之鄉", lat: 28.23, lng: 112.94, status: "neutral", tier: "minor", gold: 0, garrison: 0, development: 0, specialty: "market", food: 60 },
  { id: "jingzhou", name: "荊州", description: "荊楚重鎮，兵家必爭", lat: 30.35, lng: 112.19, status: "neutral", tier: "minor", gold: 0, garrison: 0, development: 0, specialty: "granary", food: 60 },
  { id: "tianshui", name: "天水", description: "隴右要地，伏羲故里", lat: 34.58, lng: 105.72, status: "neutral", tier: "minor", gold: 0, garrison: 0, development: 0, specialty: "forge", food: 60 },
  { id: "nanman", name: "昆明", description: "西南邊陲，南中蠻地", lat: 25.04, lng: 102.71, status: "dead", tier: "minor", gold: 0, garrison: 0, development: 0, specialty: "granary", food: 60 },
  { id: "beihai", name: "濰坊", description: "齊魯之地，東海通道", lat: 36.70, lng: 118.97, status: "neutral", tier: "minor", gold: 0, garrison: 0, development: 0, specialty: "harbor", food: 60 },
  { id: "wan", name: "南陽", description: "南陽盆地，兵家重鎮", lat: 32.99, lng: 112.53, status: "neutral", tier: "minor", gold: 0, garrison: 0, development: 0, specialty: "forge", food: 60 },
  { id: "nanhai", name: "廣州", description: "嶺南重鎮，海上絲路", lat: 23.13, lng: 113.26, status: "neutral", tier: "minor", gold: 0, garrison: 0, development: 0, specialty: "market", food: 60 },
