...
const characters: CharacterNode[] = [
  ...
  { id: "liu_bei", name: "劉備", biography: "漢室宗親，以仁義聞名天下，三顧茅廬得臥龍，終建蜀漢基業。", avatarUrl: "/avatars/liu_bei.svg", traits: ["benevolent", "ambitious", "charismatic"], cityId: "chengdu", military: 15, intelligence: 20, charm: 92, skills: { leadership: 75, tactics: 5, commerce: 15, espionage: 5 }, bornTick: -480 },
  { id: "guan_yu", name: "關羽", biography: "義薄雲天，溫酒斬華雄，千里走單騎，被尊為武聖。", avatarUrl: "/avatars/guan_yu.svg", traits: ["loyal", "brave", "proud"], cityId: "chengdu", military: 95, intelligence: 25, charm: 15, skills: { leadership: 10, tactics: 55, commerce: 0, espionage: 0 }, bornTick: -512 },
  { id: "zhang_fei", name: "張飛", biography: "燕人張翼德，長坂坡一聲喝退曹軍百萬，勇冠三軍。", avatarUrl: "/avatars/zhang_fei.svg", traits: ["brave", "impulsive", "loyal"], cityId: "hanzhong", military: 90, intelligence: 10, charm: 30, skills: { leadership: 0, tactics: 35, commerce: 0, espionage: 0 }, bornTick: -416 },
  { id: "zhuge_liang", name: "諸葛亮", biography: "臥龍先生，隆中對定三分天下，鞠躬盡瘁死而後已。", avatarUrl: "/avatars/zhuge_liang.svg", traits: ["wise", "cautious", "strategic"], cityId: "xinye", military: 15, intelligence: 98, charm: 20, skills: { leadership: 10, tactics: 15, commerce: 30, espionage: 55 }, bornTick: -352 },
  { id: "zhao_yun", name: "趙雲", biography: "常山趙子龍，長坂坡七進七出救幼主，一身是膽。", avatarUrl: "/avatars/zhao_yun.svg", traits: ["loyal", "brave", "humble"], cityId: "chengdu", military: 88, intelligence: 30, charm: 55, skills: { leadership: 0, tactics: 55, commerce: 0, espionage: 0 }, bornTick: -400 },
  { id: "wei_yan", name: "魏延", biography: "蜀漢猛將，鎮守漢中多年，善奇謀，性格桀驁不馴。", avatarUrl: "/avatars/wei_yan.svg", traits: ["brave", "ambitious", "impulsive"], cityId: "hanzhong", military: 90, intelligence: 25, charm: 10, skills: { leadership: 0, tactics: 50, commerce: 0, espionage: 0 }, bornTick: -400 },
  { id: "jiang_wei", name: "姜維", biography: "天水麒麟兒，諸葛亮欽點的接班人，九伐中原矢志不渝。", avatarUrl: "/avatars/jiang_wei.svg", traits: ["loyal", "strategic", "ambitious"], cityId: "chengdu", military: 82, intelligence: 78, charm: 30, skills: { leadership: 25, tactics: 50, commerce: 0, espionage: 0 }, bornTick: -288 },
  { id: "fa_zheng", name: "法正", biography: "蜀漢謀主，獻計取益州，劉備最信賴的軍師之一。", avatarUrl: "/avatars/fa_zheng.svg", traits: ["cunning", "strategic", "ambitious"], cityId: "chengdu", military: 10, intelligence: 90, charm: 25, skills: { leadership: 0, tactics: 0, commerce: 30, espionage: 50 }, bornTick: -384 },

  // Wei faction — centered on Luoyang
  { id: "cao_cao", name: "曹操", biography: "亂世之奸雄，治世之能臣。挾天子以令諸侯，統一北方。", avatarUrl: "/avatars/cao_cao.svg", traits: ["ambitious", "cunning", "charismatic"], cityId: "luoyang", military: 30, intelligence: 85, charm: 80, skills: { leadership: 60, tactics: 0, commerce: 35, espionage: 0 }, bornTick: -576 },
  { id: "xu_huang", name: "徐晃", biography: "曹魏五子良將之一，治軍嚴謹，樊城之戰大破關羽。", avatarUrl: "/avatars/xu_huang.svg", traits: ["loyal", "brave", "cautious"], cityId: "xuchang", military: 85, intelligence: 40, charm: 25, skills: { leadership: 0, tactics: 50, commerce: 0, espionage: 0 }, bornTick: -448 },
  { id: "xiahou_dun", name: "夏侯惇", biography: "曹操族弟，獨眼將軍，拔矢啖睛的猛將，忠心耿耿。", avatarUrl: "/avatars/xiahou_dun.svg", traits: ["brave", "loyal", "proud"], cityId: "luoyang", military: 92, intelligence: 25, charm: 30, skills: { leadership: 25, tactics: 50, commerce: 0, espionage: 0 }, bornTick: -512 },
  { id: "xiahou_yuan", name: "夏侯淵", biography: "曹魏名將，擅長急行軍，三日五百里，定軍山戰死。", avatarUrl: "/avatars/xiahou_yuan.svg", traits: ["brave", "impulsive", "ambitious"], cityId: "changan", military: 90, intelligence: 25, charm: 10, skills: { leadership: 0, tactics: 50, commerce: 0, espionage: 0 }, bornTick: -480 },
  { id: "dian_wei", name: "典韋", biography: "古之惡來，曹操貼身護衛，濮陽戰以一當十，壯烈殉主。", avatarUrl: "/avatars/dian_wei.svg", traits: ["brave", "loyal", "impulsive"], cityId: "luoyang", military: 97, intelligence: 5, charm: 5, skills: { leadership: 0, tactics: 25, commerce: 0, espionage: 0 }, bornTick: -480 },
  { id: "xun_yu", name: "荀彧", biography: "王佐之才，曹操首席謀臣，居中持重，運籌帷幄。", avatarUrl: "/avatars/xun_yu.svg", traits: ["wise", "loyal", "cautious"], cityId: "xuchang", military: 10, intelligence: 95, charm: 60, skills: { leadership: 30, tactics: 0, commerce: 55, espionage: 0 }, bornTick: -448 },
  { id: "guo_jia", name: "郭嘉", biography: "鬼才軍師，算無遺策，官渡之戰獻十勝十敗論，英年早逝。", avatarUrl: "/avatars/guo_jia.svg", traits: ["wise", "cunning", "strategic"], cityId: "luoyang", military: 5, intelligence: 97, charm: 40, skills: { leadership: 0, tactics: 30, commerce: 0, espionage: 55 }, bornTick: -416 },
  { id: "zhang_liao", name: "張遼", biography: "曹魏五子良將之首，逍遙津八百破十萬，威震江東。", avatarUrl: "/avatars/zhang_liao.svg", traits: ["brave", "strategic", "loyal"], cityId: "hefei", military: 92, intelligence: 50, charm: 30, skills: { leadership: 0, tactics: 70, commerce: 0, espionage: 0 }, bornTick: -448 },

  // Wu faction — centered on Jianye
  { id: "sun_quan", name: "孫權", biography: "紫髯碧眼，承父兄基業，善用人才，穩固江東霸業。", avatarUrl: "/avatars/sun_quan.svg", traits: ["cautious", "diplomatic", "ambitious"], cityId: "jianye", military: 25, intelligence: 78, charm: 82, skills: { leadership: 30, tactics: 0, commerce: 55, espionage: 0 }, bornTick: -320 },
  { id: "zhou_yu", name: "周瑜", biography: "美周郎，赤壁大破曹軍，精通音律，文武雙全。", avatarUrl: "/avatars/zhou_yu.svg", traits: ["strategic", "proud", "ambitious"], cityId: "jianye", military: 60, intelligence: 88, charm: 20, skills: { leadership: 0, tactics: 55, commerce: 0, espionage: 25 }, bornTick: -384 },
  { id: "gan_ning", name: "甘寧", biography: "錦帆賊出身，百騎劫曹營，孫權麾下水戰悍將。", avatarUrl: "/avatars/gan_ning.svg", traits: ["brave", "impulsive", "charismatic"], cityId: "jiangxia", military: 85, intelligence: 20, charm: 50, skills: { leadership: 0, tactics: 25, commerce: 20, espionage: 0 }, bornTick: -400 },
  { id: "lu_su", name: "魯肅", biography: "東吳重臣，力主孫劉聯盟，單刀赴會維護外交大局。", avatarUrl: "/avatars/lu_su.svg", traits: ["wise", "diplomatic", "loyal"], cityId: "jianye", military: 10, intelligence: 88, charm: 75, skills: { leadership: 55, tactics: 0, commerce: 30, espionage: 0 }, bornTick: -416 },
  { id: "huang_gai", name: "黃蓋", biography: "三朝元老，赤壁之戰獻苦肉計，火燒曹營立下大功。", avatarUrl: "/avatars/huang_gai.svg", traits: ["loyal", "brave", "cunning"], cityId: "jiangxia", military: 80, intelligence: 45, charm: 25, skills: { leadership: 0, tactics: 30, commerce: 0, espionage: 25 }, bornTick: -576 },
  { id: "taishi_ci", name: "太史慈", biography: "東萊猛將，弓馬嫻熟，與孫策神亭酣戰後歸順東吳。", avatarUrl: "/avatars/taishi_ci.svg", traits: ["brave", "loyal", "proud"], cityId: "kuaiji", military: 90, intelligence: 20, charm: 30, skills: { leadership: 0, tactics: 50, commerce: 0, espionage: 0 }, bornTick: -448 },
  { id: "lv_meng", name: "呂蒙", biography: "吳下阿蒙，士別三日刮目相看，白衣渡江奪取荊州。", avatarUrl: "/avatars/lv_meng.svg", traits: ["strategic", "cunning", "ambitious"], cityId: "jianye", military: 60, intelligence: 82, charm: 25, skills: { leadership: 0, tactics: 50, commerce: 0, espionage: 25 }, bornTick: -384 },

  // Lu Bu faction — centered on Xiapi
  { id: "lu_bu", name: "呂布", biography: "人中呂布馬中赤兔，天下無雙的飛將軍，三姓家奴。", avatarUrl: "/avatars/lu_bu.svg", traits: ["brave", "treacherous", "impulsive"], cityId: "xiapi", military: 99, intelligence: 8, charm: 5, skills: { leadership: 5, tactics: 80, commerce: 0, espionage: 0 }, bornTick: -560 },
  { id: "diao_chan", name: "貂蟬", biography: "四大美人之一，連環計離間董卓與呂布，以美色改寫歷史。", avatarUrl: "/avatars/diao_chan.svg", traits: ["charismatic", "cunning", "diplomatic"], cityId: "xiapi", military: 5, intelligence: 75, charm: 98, skills: { leadership: 20, tactics: 0, commerce: 0, espionage: 55 }, bornTick: -320 },

  // Neutral (unaffiliated) characters
  { id: "xu_shu", name: "徐庶", biography: "本為劉備謀士，因母被挾而入曹營，一言不發終身不獻一策。", avatarUrl: "/avatars/xu_shu.svg", traits: ["wise", "loyal", "humble"], cityId: "changsha", military: 25, intelligence: 88, charm: 45, skills: { leadership: 0, tactics: 30, commerce: 0, espionage: 25 }, bornTick: -448 },
  { id: "pang_tong", name: "龐統", biography: "鳳雛先生，與臥龍齊名，獻連環計助赤壁之勝，落鳳坡殞命。", avatarUrl: "/avatars/pang_tong.svg", traits: ["wise", "strategic", "cunning"], cityId: "nanman", military: 10, intelligence: 96, charm: 25, skills: { leadership: 0, tactics: 55, commerce: 25, espionage: 0 }, bornTick: -416 },
  { id: "huang_zhong", name: "黃忠", biography: "老當益壯，定軍山斬夏侯淵，百步穿楊的神弓手。", avatarUrl: "/avatars/huang_zhong.svg", traits: ["brave", "loyal", "proud"], cityId: "changsha", military: 96, intelligence: 10, charm: 30, skills: { leadership: 0, tactics: 65, commerce: 0, espionage: 0 }, bornTick: -800 },
  { id: "ma_chao", name: "馬超", biography: "西涼錦馬超，為父報仇割據一方，後歸順劉備封五虎上將。", avatarUrl: "/avatars/ma_chao.svg", traits: ["brave", "impulsive", "ambitious"], cityId: "tianshui", military: 93, intelligence: 20, charm: 45, skills: { leadership: 25, tactics: 45, commerce: 0, espionage: 0 }, bornTick: -352 },
